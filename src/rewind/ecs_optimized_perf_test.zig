...
// Optimized system implementations using fast iteration
fn updateTransformSystem(frame: *GenericECS.Frame) !void {
    ...
    // Use fast iterator for word-level iteration
    var iter = query.createFastIterator();
...
pub fn main() !void {
    // Use page allocator for fair comparison with optimized test
    const allocator = std.heap.page_allocator;
    
    std.debug.print("=== Optimized Generic ECS Performance Test ===\n", .{});
    std.debug.print("Testing with custom bitset and fast iteration\n\n", .{});
    ...
    std.debug.print("\n=== End of Optimized Generic ECS Performance Test ===\n", .{});
}